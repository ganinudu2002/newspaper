        ...
        <div class="SecHead">
            ...
            <div class = "hhead">
                <div class = "mainnewshead">
                        <?php
                            $query ="SELECT * FROM sport ORDER BY id DESC LIMIT 1";
                            $result  = $conn->query($query);
                            $row = $result->fetch_assoc()
                        ?>
                        <a href="sport-view.php?id=<?php echo $row['id'];?>">
                        <div class="mainnews">
                            <h1><?php echo $row['head'];?></h1>
                            <img src = "../../photos/sport_photos/<?php echo $row['pic'];?>" alt="India vs SA Final" class="IndvsSAimg">
                        </div>
                        </a>
                </div>
                ...
                <div class="sidepart">
                    <?php
                        ...
                        $query = "SELECT n.*, RIGHT(n.content, 40) AS short_title FROM sport AS n WHERE n.id  ORDER BY id DESC LIMIT 4 OFFSET 1;";
                    ...
                    <a href="sport-view.php?id=<?php echo $row['id'];?>">
                        <div class = "yupun">
                            ...
                            <img src="../../photos/sport_photos/<?php echo $row['pic']; ?>" alt=".." class="yupunimg">
                        </div>
                    </a>  
            ...
            <?php
                // $query = "SELECT n.*, RIGHT(n.content, 40) AS short_title FROM sport AS n ORDER BY id DESC ;";
                $query = "SELECT n.*, RIGHT(n.content, 40) AS short_title FROM sport AS n WHERE n.id ORDER BY id DESC LIMIT 3 OFFSET 5";
                $rows = $conn->query($query);
                if (!$rows) {
                    echo "Error: Could not execute query. " . $conn->error;  // showing execution errors
                    exit();
                ...
                <a href="sport-view.php?id=<?php echo $row['id'];?>">
                    <div class="section3">
                        <h2><?php echo $row['head']; ?></h2>
                        <img src="../../photos/sport_photos/<?php echo $row['pic']; ?>" class="WIvsSLimg"><br>
            ...
            <div class="thirdpart">
                <?php
                $query = "SELECT n.*, RIGHT(n.content, 40) AS short_title FROM sport AS n ORDER BY id DESC LIMIT 18446744073709551615 OFFSET 9;";
                $rows = $conn->query($query);
                if (!$rows) {
                    echo "Error: Could not execute query. " . $conn->error;  // showing execution errors
                    exit();
                ...
                <div class="Tsec1">
                    ...
                    <img src="../../photos/sport_photos/<?php echo $row['pic']; ?>"><br><!-- news picture -->
